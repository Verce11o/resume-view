...
//
//	mockgen -source=service.go -destination=mocks/services.go -package=mocks -mock_names=Employee=MockEmployeeService,Position=MockPositionService
//
...
func (m *MockEmployeeService) SignIn(ctx context.Context, employeeID uuid.UUID) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEmployeeServiceMockRecorder) SignIn(ctx, employeeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SignIn", reflect.TypeOf((*MockEmployeeService)(nil).SignIn), ctx, employeeID)
}
