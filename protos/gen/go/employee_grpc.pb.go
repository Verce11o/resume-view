...
const (
	EmployeeService_CreateEmployee_FullMethodName  = "/resume_view.EmployeeService/CreateEmployee"
	EmployeeService_GetEmployee_FullMethodName     = "/resume_view.EmployeeService/GetEmployee"
...
func (c *employeeServiceClient) GetEmployeeList(ctx context.Context, in *GetEmployeeListRequest, opts ...grpc.CallOption) (*GetEmployeeListResponse, error) {
	out := new(GetEmployeeListResponse)
	err := c.cc.Invoke(ctx, EmployeeService_GetEmployeeList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEmployeeServiceServer) GetEmployeeList(context.Context, *GetEmployeeListRequest) (*GetEmployeeListResponse, error) {
...
func _EmployeeService_GetEmployeeList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployeeList(ctx, req.(*GetEmployeeListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "resume_view.EmployeeService",
